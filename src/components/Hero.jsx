  ...
  return (
    ...
    style={{
        ...
        <div className='flex flex-col justify-center w-[30rem] h-full p-[2rem]'>
         ...
         <p className=' text-white text-xl py-5'>PicsFolio is an image gallery website that showcases a variety of images. One of its standout features is the drag-and-drop functionality, allowing you to effortlessly rearrange images to your liking. Enjoy your exploration!</p>
